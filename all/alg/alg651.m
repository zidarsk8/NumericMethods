...
% Podatki:
% 		f651		desna stran diferencialne enacbe
%		x0			zacetna tocka 
...
while x < b
   k1 = h*f651(x,y);
   k2 = h*f651(x + h/5, y + k1/5);
   k3 = h*f651(x + h*0.3, y + k1*0.075 + k2*0.225);
   k4 = h*f651(x+h*0.8, y+44*k1/45-56*k2/15+32*k3/9);
   k5 = h*f651(x+8*h/9, y+19372*k1/6561-25360*k2/2187+64448*k3/6561-212*k4/729);
   k6 = h*f651(x+h, y+9017*k1/3168-355*k2/33+46732*k3/5247+49*k4/176-5103*k5/18656);
   k7 = h*f651(x+h, y+35*k1/384+500*k3/1113+125*k4/192-2187*k5/6784+11*k6/84);
